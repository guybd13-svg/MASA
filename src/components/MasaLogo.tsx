      ...
      <g mask="url(#a)">
        <g filter="url(#b)">
          <ellipse
            ...
            rx="5.508"
            ry="14.704"
            style={{ fill: '#ede6ff', fillOpacity: 1 }}
        ...
        <g filter="url(#d)">
          <ellipse
            ...
            rx="5.508"
            ry="30.487"
            style={{ fill: '#7e14ff', fillOpacity: 1 }}
        ...
        <g filter="url(#l)">
          <ellipse
            ...
            rx="5.971"
            ry="9.665"
            style={{ fill: '#47bfff', fillOpacity: 1 }}
